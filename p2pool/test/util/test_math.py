...
class Test(unittest.TestCase):
    ...
    def test_convertbits(self):
        ...
        self.assertListEqual([4, 11, 13, 2, 16],
                math.convertbits([34, 218, 40], 8, 5, True))
        self.assertListEqual([34, 218, 40, 0],
                math.convertbits([4, 11, 13, 2, 16], 5, 8, True))
        self.assertListEqual([34, 218, 40],
                math.convertbits([4, 11, 13, 2, 16], 5, 8, False))
        self.assertListEqual([3, 82, 34, 218, 40],
                math.convertbits([0, 13, 9, 2, 5, 22, 17, 8], 5, 8, True))
        self.assertListEqual([3, 82, 34, 218, 40],
                math.convertbits([0, 13, 9, 2, 5, 22, 17, 8], 5, 8, False))
        self.assertListEqual([0, 13, 9, 2, 5, 22, 17, 8],
                math.convertbits([3, 82, 34, 218, 40], 8, 5, True))
        self.assertListEqual([0, 13, 9, 2, 5, 22, 17, 8],
                math.convertbits([3, 82, 34, 218, 40], 8, 5, False))
